...
if(is_file($p['config']['webDirectory'].'../config/configAgenda'.$p['user']['id'].'.yml')) {
  $p['page']['agenda']=Spyc::YAMLLoad($p['config']['webDirectory'].'../config/configAgenda'.$p['user']['id'].'.yml');
} else {
...
if(is_file($p['config']['webDirectory'].'../config/configTypesRdv'.$p['user']['id'].'.yml')) {
    $consults=Spyc::YAMLLoad($p['config']['webDirectory'].'../config/configTypesRdv'.$p['user']['id'].'.yml');

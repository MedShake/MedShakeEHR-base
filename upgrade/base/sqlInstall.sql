...
('smtpFrom', 'propre', 'Mail', 'default', 'texte', 'user@domain.net', ''),
...
('faxService', 'propre', 'Fax', 'default', 'url/ip', 'ex: ecofaxOVH', ''),
('ecofaxMyNumber', 'tiers', 'Fax', 'default', 'nombre', 'ex: 0900000000', ''),

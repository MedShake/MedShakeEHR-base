...
('click2callService', 'default', '0', NULL, 'Click2call', 'string', 'nom du service Click2call à activer (OVH)', NULL),
...
('ovhApplicationKey', 'default', '0', NULL, 'Click2call', 'string', 'OVH Application Key', NULL),
('ovhApplicationSecret', 'default', '0', NULL, 'Click2call', 'string', 'OVH Application Secret', NULL),
('ovhConsumerKey', 'default', '0', NULL, 'Click2call', 'string', 'OVH Consumer Key', NULL),
('ovhTelecomBillingAccount', 'default', '0', NULL, 'Click2call', 'string', 'Informations sur la ligne > Nom du groupe', NULL),
('ovhTelecomCallingNumber', 'default', '0', NULL, 'Click2call', 'string', 'Numéro de l\'appelant au format international 0033xxxxxxxxxx', NULL),
('ovhTelecomIntercom', 'default', '0', NULL, 'Click2call', 'true/false', 'Activer le mode intercom', NULL),
('ovhTelecomServiceName', 'default', '0', NULL, 'Click2call', 'string', 'Numéro de la ligne au format international 0033xxxxxxxxxx', NULL),

...
(5, 'medical', 'catDataTransversesFormCs', 'Données transverses', 'champs utilisables dans tous formulaires (codage des actes par exemple)', 'base', 1, '2018-12-07 11:38:30'),
...
(16, 'medical', 'codeTechniqueExamen', '', 'Acte lié à l\'examen réalisé', 'code acte caractérisant l\'examen fait via le formulaire qui l\'emploie', '', '', 'text', '', 'base', 5, 1, '2018-12-07 11:40:29', 3600, 1),
...
(41, 'medical', 'atcdMedicChir', 'Antécédents médico-chirurgicaux personnels', 'Antécédents médico-chirurgicaux', 'Antécédents médico-chirurgicaux personnels', '', '', 'textarea', '', 'base', 29, 1, '2018-01-01 00:00:00', 3600, 1),
...
(67, 'reglement', 'regleFseData', '', 'FSE data', 'data de la FSE générée par service tiers', '', '', 'text', '', 'base', 46, 1, '2018-01-01 01:00:00', 1576800000, 1),
(68, 'admin', 'PSIdNat', '', 'Identifiant national praticien santé', 'identifiant national praticien santé', '', '', 'text', '', 'base', 36, 1, '2018-11-23 11:49:03', 3600, 1),
(69, 'admin', 'PSCodeProSpe', '', 'Code normé de la profession/spécialité du praticien', 'code normé de la profession/spécialité du praticien', '', '', 'select', '\'Z\' : \'Jeu de valeurs normées absent\'', 'base', 36, 1, '2018-11-26 11:39:13', 3600, 1),
(70, 'admin', 'PSCodeStructureExercice', '', 'Code normé de la structure d\'exercice du praticien', 'code normé de la structure d\'exercice du praticien', '', '', 'select', '\'Z\' : \'Jeu de valeurs normées absent\'', 'base', 36, 1, '2018-11-26 11:39:24', 3600, 1),
...
(190, 'reglement', 'reglePorteurS1', '', 'Règlement', 'Règlement conventionné S1', '', '', '', 'baseReglementS1', 'base', 45, 1, '2018-01-01 00:00:00', 1576800000, 1),
(191, 'reglement', 'reglePorteurS2', '', 'Règlement', 'Règlement conventionné S2', '', '', '', 'baseReglementS2', 'base', 45, 1, '2018-01-01 00:00:00', 1576800000, 1),
(192, 'reglement', 'reglePorteurLibre', '', 'Règlement', 'Règlement hors convention', '', '', '', 'baseReglementLibre', 'base', 45, 1, '2018-01-01 00:00:00', 1576800000, 1),
...
(490, 'relation', 'relationPatientPraticien', '', 'Relation patient praticien', 'relation patient  praticien', '', '', 'select', '\'MTD\': \'Médecin traitant déclaré\'\n\'MT\': \'Médecin traitant\'\n\'MS\': \'Médecin spécialiste\'\n\'Autre\': \'Autre correspondant\'', 'base', 63, 1, '2018-01-01 00:00:00', 1576800000, 1),
...
(8, 'formsProdOrdoEtDoc', 'Formulaires de production d\'ordonnances', 'formulaires de production d\'ordonnances et de documents', 'user', 1, '2018-12-19 11:01:59');
...
('administratifPeutAvoirRecettes', 'Règlements', 'default', 'true/false', 'peut enregistrer des recettes à son nom', 'true'),
('administratifComptaPeutVoirRecettesDe', 'Règlements', 'default', 'liste', 'ID des utilisateurs, séparés par des virgules (sans espace)', ''),
...
('templatesCdaFolder', 'Modèles de documents', 'default', 'dossier', 'répertoire des fichiers de template pour la génération de XML CDA', ''),
...
( 'administratifSecteurGeoTarifaire', 'Règlements', 'default', 'dossier', 'zone géographique tarifaire (metro, 971, 972 ...)', 'metro'),
( 'administratifReglementFormulaires', 'Règlements', 'default', 'liste', 'liste des formulaires de règlement disponible dans le dossier patient ', 'reglePorteurS1,reglePorteurS2,reglePorteurLibre'),
('signPeriphName', 'Options', 'default', 'texte', 'nom du périphérique pour signature (caractères alphanumériques, sans espaces ni accents)', 'default'),

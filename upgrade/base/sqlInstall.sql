...
('typecs', 'csAutres', 'Autres', 'autres', 'user', '1', '2019-01-01 00:00:00'),
('medical', 'dataCliniques', 'Données cliniques', 'Données cliniques', 'user', '1', '2019-01-01 00:00:00'),
('typecs', 'csBase', 'Consultations', 'consultations possibles', 'user', '1', '2019-01-01 00:00:00'),
('medical', 'dataCsBase', 'Données formulaire Cs', NULL, 'user', '1', '2019-01-01 00:00:00'),
...
('typecs', 'declencheur', 'Déclencheur', NULL, 'user', '1', '2019-01-01 00:00:00'),
...
('mail', 'dataSms', 'Data sms', 'data pour les sms envoyés', 'user', '1', '2019-01-01 00:00:00'),
('relation', 'relationRelations', 'Relations', 'types permettant de définir une relation', 'user', '1', '2019-01-01 00:00:00'),
('admin', 'catMarqueursAdminDossiers', 'Marqueurs', 'marqueurs dossiers', 'user', '1', '2019-01-01 00:00:00'),
...
SET @catID = (SELECT data_cat.id FROM data_cat WHERE data_cat.name='');
INSERT IGNORE INTO `data_types` (`groupe`, `name`, `placeholder`, `label`, `description`, `validationRules`, `validationErrorMsg`, `formType`, `formValues`, `module`, `cat`, `fromID`, `creationDate`, `durationLife`, `displayOrder`) VALUES

...
update data_types set placeholder='nom reçu à la naissance', label='Nom de naissance', description='Nom reçu à la naissance' where name='lastname';
update data_types set placeholder='nom utilisé au quotidien', label='Nom d\'usage', description='Nom utilisé au quotidien', name='usageName' where name='birthname';
